...
export const programFamilies: ProgramFamily[] = [
  ...
  },
  {
    ...
    title: '처음 5분 달리기',
    subtitle: '3주 · 주 3회',
    description: '10분이 아직 멀게 느껴진다면 여기부터예요. 5분을 이어 달리는 것이 목표예요.',
    category: 'START',
    eligibility: { minLevel: 'L0_MOVE' },
    releaseGate: 'NOW',
    recipe: {
      startRunSeconds: 30,
      endRunSeconds: 300,
      startTotalRunSeconds: 150,
      endTotalRunSeconds: 300,
      walkRatio: 2,
      weeks: 3,
      daysPerWeek: 3,
    },
  },
  {
    ...
    title: '40분 이어 달리기',
    subtitle: '8주 · 주 3회',
    description: '30분이 편해졌다면 다음은 40분이에요. 속도는 그대로 두고 시간만 늘려요.',
    category: 'BASE',
    eligibility: { minLevel: 'L3_RUN_30' },
    releaseGate: 'NOW',
    recipe: {
  ...
  },
  {
    ...
    title: '한 시간 이어 달리기',
    subtitle: '10주 · 주 3회',
    description: '한 시간을 편하게 달릴 수 있게 만들어요. 긴 거리의 바탕이 되는 힘이에요.',
    category: 'BASE',
    eligibility: { minLevel: 'L4_5K' },
    releaseGate: 'NOW',
    recipe: {
  ...
  },
  {
    ...
    title: '주 4번 리듬 만들기',
    subtitle: '8주 · 주 4회',
    description: '한 번에 길게 하기보다 자주 나가는 쪽이 편한 사람에게 맞아요.',
    category: 'BASE',
    eligibility: { minLevel: 'L4_5K' },
    releaseGate: 'NOW',
    recipe: {
      startRunSeconds: 1500,
      endRunSeconds: 2400,
      startTotalRunSeconds: 1500,
      endTotalRunSeconds: 2400,
      walkRatio: 0.4,
  ...
  },
  {
    ...
    title: '처음 3km 완주',
    subtitle: '6주 · 주 3회',
    description: '5km가 아직 부담이라면 3km부터 확실하게 만들어요.',
    category: 'FIVE_TEN_K',
    eligibility: { minLevel: 'L2_RUN_10' },
    releaseGate: 'NOW',
    recipe: {
  ...
  },
  {
    ...
    title: '10km 기록 다듬기',
    subtitle: '8주 · 주 3회',
    description: '이미 10km를 달리는 분이 같은 거리를 조금 더 편하게 가도록 다듬어요.',
    category: 'IMPROVE',
    eligibility: {
      minLevel: 'L5_10K',
      minLongestRunKm: 8,
  ...
  },
  {
    ...
    title: '3km 다듬기',
    subtitle: '6주 · 주 3회',
    description: '짧은 거리를 여러 번 나눠 달리며 다리에 리듬을 넣어요.',
    category: 'IMPROVE',
    eligibility: { minLevel: 'L4_5K' },
    releaseGate: 'ELIGIBILITY',
    recipe: {
  ...
  {
    id: 'return-long-break',
    title: '반년 넘게 쉬었다가',
    subtitle: '8주 · 주 3회',
    description: '예전에 달렸더라도 몸은 처음으로 돌아가 있어요. 욕심내지 않고 다시 쌓아요.',
    category: 'RETURN',
    eligibility: { minLevel: 'L0_MOVE' },
    releaseGate: 'NOW',
    recipe: {
  ...
  {
    id: 'return-after-injury',
    title: '아팠다가 돌아오기',
    subtitle: '6주 · 주 3회',
    description: '아픈 곳이 있었다면 반드시 병원에서 확인한 뒤에 시작해요.',
    category: 'RETURN',
    eligibility: { minLevel: 'L0_MOVE' },
    // 다친 몸으로 시작하면 되돌릴 수 없습니다. 전문가 검수 전에는 열지 않습니다.
    releaseGate: 'EXPERT_REQUIRED',
    recipe: {
      startRunSeconds: 60,
      endRunSeconds: 450,
      startTotalRunSeconds: 240,
      endTotalRunSeconds: 900,
      walkRatio: 1.5,
      weeks: 6,
      daysPerWeek: 3,
  ...
  },
  {
    ...
    title: '러닝머신 30분',
    subtitle: '8주 · 주 3회',
    description: '실내에서 30분을 이어 달릴 수 있게 만들어요. 날씨와 상관없이 이어갈 수 있어요.',
    category: 'INDOOR',
    eligibility: { minLevel: 'L1_RUN_WALK' },
    releaseGate: 'NOW',
    recipe: {
  ...
  },
  {
    ...
    title: '러닝머신 5km',
    subtitle: '8주 · 주 3회',
    description: '실내에서 5km에 해당하는 시간을 이어 달려요. 속도는 기계에 맡기고 시간만 봐요.',
    category: 'INDOOR',
    eligibility: { minLevel: 'L3_RUN_30' },
    releaseGate: 'NOW',
    recipe: {
  ...
  },
  {
    ...
    title: '주말에만 달리기',
    subtitle: '8주 · 주 2회',
    description: '평일에는 시간이 없어도 괜찮아요. 토·일 두 번으로 이어가요.',
    category: 'LIFESTYLE',
    eligibility: { minLevel: 'L1_RUN_WALK' },
    releaseGate: 'NOW',
    recipe: {
  ...
  },
  {
    ...
    title: '점심시간 30분',
    subtitle: '6주 · 주 3회',
    description: '한 회차가 30분을 넘지 않아요. 점심시간에 나갔다 들어올 수 있어요.',
    category: 'LIFESTYLE',
    eligibility: { minLevel: 'L2_RUN_10' },
    releaseGate: 'NOW',
    recipe: {
  ...
  },
  {
    ...
    title: '교대 근무에 맞춰',
    subtitle: '6주 · 주 2회',
    description: '요일이 들쭉날쭉해도 괜찮아요. 주 2회만 채우면 되는 계획이에요.',
    category: 'LIFESTYLE',
    eligibility: { minLevel: 'L1_RUN_WALK' },
    releaseGate: 'NOW',
    recipe: {
  ...
  },
  {
    ...
    title: '10km 대회 뒤 3주',
    subtitle: '3주 · 주 3회',
    description: '대회 뒤에는 쌓지 않고 풀어요. 다음을 위해 지금 쉬어 주는 시간이에요.',
    category: 'RECOVERY',
    eligibility: { minLevel: 'L4_5K' },
    releaseGate: 'NOW',
    recipe: {
  ...
  },
  {
    ...
    title: '피곤한 주 넘기기',
    subtitle: '2주 · 주 3회',
    description: '몸이 무거운 주에 쓰는 계획이에요. 멈추지 않되 늘리지도 않아요.',
    category: 'RECOVERY',
    eligibility: { minLevel: 'L1_RUN_WALK' },
    releaseGate: 'NOW',
    recipe: {
      ...
      startTotalRunSeconds: 480,
      endTotalRunSeconds: 600,
      // 회복 계획은 밖에 머무는 시간 자체가 짧아야 합니다. 걷기를 뛴 만큼만 둡니다.
      walkRatio: 1,
      weeks: 2,
      daysPerWeek: 3,
    },
