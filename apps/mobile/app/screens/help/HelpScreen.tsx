...
const faqs: Faq[] = [
  ...
  },
  {
    ...
    answer:
      '현재 자동 가져오기를 지원하지 않아요. 러닝봄 코치로 끝낸 기록은 자동 저장되고, 다른 앱에서 한 활동은 캘린더에서 직접 입력할 수 있어요.',
  },
  {
    id: 'race-count',
    category: '대회·러닝화',
  ...
  },
  {
    ...
    answer:
      '대회 화면에서 원하는 대회를 열고 접수 알림을 켜면, 접수 시각이 확인된 대회에 한해 알림을 예약해요. 알림을 꺼도 대회 탐색과 접수 페이지·정보 출처 링크는 그대로 쓸 수 있어요.',
  },
  {
    id: 'device-change',
    category: '기록·데이터',
